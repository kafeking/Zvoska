const CACHE='zvoska-fest-2026-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/map-prizemi.jpg','./assets/map-1patro.jpg','./assets/map-2patro.jpg','./assets/icon-192.png','./assets/icon-512.png'];
