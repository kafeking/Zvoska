const CACHE='zvoska-fest-2026-v5-hires-map-100';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./map-prizemi.png','./map-1patro.png','./map-2patro.png','./icon-192.png','./icon-512.png'];
