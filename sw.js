const CACHE='zvoska-fest-2026-v4-search-descriptions';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./map-prizemi.jpg','./map-1patro.jpg','./map-2patro.jpg','./icon-192.png','./icon-512.png'];
